tableextension 70025 SalesInvoiceHeaderExt extends "Sales Invoice Header"
{
    ...
    fields
    {
        ...
        field(80103; "Transport Method1"; Code[20])
        {
            DataClassification = CustomerContent;
        }
        field(80104; "Sell-to Address1"; Text[100])
        {
            DataClassification = CustomerContent;
        }
        field(80105; "Sell-to Address 21"; Text[100])
        {
            DataClassification = CustomerContent;
        }
        field(80106; "Sell-to City1"; Text[100])
        {
            DataClassification = CustomerContent;
        }
        field(80107; "Form No.1"; Code[20])
        {
            DataClassification = CustomerContent;
        }
    }
