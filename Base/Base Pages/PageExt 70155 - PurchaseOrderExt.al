            ...
            action("Print & Send Mail to supplier")
            {
                ...
                begin
                    ...
                    IF (USERID IN ['EFFTRONICS\NSUDHEER', 'EFFTRONICS\CHOWDARY', 'EFFTRONICS\BRAHMAIAH', 'EFFTRONICS\RENUKACH', 'EFFTRONICS\ANANDA', 'EFFTRONICS\PARDHU', 'EFFTRONICS\ANILKUMAR',
                        'EFFTRONICS\GRAVI', 'EFFTRONICS\ANVESH', 'EFFTRONICS\SPURTHI', 'EFFTRONICS\RAVIKIRAN', 'EFFTRONICS\SUJANI', 'EFFTRONICS\VISHNUPRIYA', 'EFFTRONICS\PADMASRI', 'EFFTRONICS\PKOTESWARARAO']) AND (Status = Status::Released) THEN BEGIN
                        no_atch_items := '';
                        PurchLine.RESET();
