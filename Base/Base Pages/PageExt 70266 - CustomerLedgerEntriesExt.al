pageextension 70266 CustomerLedgerEntriesExt extends 25
{
                ...
                field(FiscialYear; FiscialYear)
                {
                    ...
                    begin
                        ...
                        IF USERID IN ['EFFTRONICS\DURGARAOV', 'EFFTRONICS\RAMKUMARL', 'EFFTRONICS\SITARAJYAM', 'EFFTRONICS\PURNACHAND',
                                      'EFFTRONICS\SGANESH', 'EFFTRONICS\DSR', 'EFFTRONICS\RAJANI', 'EFFTRONICS\ASWINI', 'EFFTRONICS\VIJAYA', 'EFFTRONICS\SUSMITHAL', 'EFFTRONICS\ANILKUMAR', 'EFFTRONICS\VISHNUPRIYA', 'EFFTRONICS\B2BOTS'] THEN BEGIN
                            CLE.RESET;
                            CLE.COPYFILTERS(Rec);
                            TotalCredit := 0;
                            TotalDebit := 0;
    ...
    begin
        IF Rec.GETFILTER("Document No.") = '' THEN BEGIN
            IF USERID IN ['EFFTRONICS\DSR', 'EFFTRONICS\SITARAJYAM', 'EFFTRONICS\RAJANI', 'EFFTRONICS\ASWINI', 'EFFTRONICS\VIJAYA', 'EFFTRONICS\SUSMITHAL', 'EFFTRONICS\ANILKUMAR', 'EFFTRONICS\VISHNUPRIYA', 'EFFTRONICS\B2BOTS'] THEN BEGIN
    ...
    begin
        ...
        IF ((USERID IN ['EFFTRONICS\DURGARAOV', 'EFFTRONICS\SGANESH', 'EFFTRONICS\DSR', 'EFFTRONICS\RAMKUMARL',
                        'EFFTRONICS\SITARAJYAM', 'EFFTRONICS\PURNACHAND', 'EFFTRONICS\RAJANI', 'EFFTRONICS\ASWINI', 'EFFTRONICS\VIJAYA', 'EFFTRONICS\SUSMITHAL', 'EFFTRONICS\ANILKUMAR', 'EFFTRONICS\VISHNUPRIYA', 'EFFTRONICS\B2BOTS']) AND (CNT = 0)) THEN BEGIN
    ...
    var
        ...
        OpeningBal: Decimal;
        FiscialYear: Option "08-09","09-10","10-11","11-12","12-13","13-14","14-15","15-16","16-17","17-18","18-19","19-20","20-21";
        CNT: Integer;
