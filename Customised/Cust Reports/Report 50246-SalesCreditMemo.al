        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    /*
                    column(QR_CODE; EInvoiceEntry."QR Code")
                    {
                    }*/
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        column(SourceDoctType; 'Ref: ' + FORMAT("Source Document Type", 0))
                        {
                        }
                        column(SourceDocNo_SalesCrMemoLine; "Source Document No.")
                        {
                        }
                        column(Supplementary_SalesCrMemoLine; Supplementary)
                        {
                        }*/
                        ...
                        /*
                        column(ExciseAmt_SalesCrMemoLine; "Excise Amount")
                        {
                            AutoFormatExpression = "Sales Cr.Memo Line".GetCurrencyCode;
                            AutoFormatType = 1;
                        }
                        column(ServTaxAmt_SalesCrMemoLine; "Service Tax Amount")
                        {
                            AutoFormatExpression = "Sales Cr.Memo Line".GetCurrencyCode;
                            AutoFormatType = 1;
                        }
                        column(ServTaxeCessAmt_SalesCrMemoLine; "Service Tax eCess Amount")
                        {
                        }*/
                        column(TDSTCSAmt_SalesCrMemoLine; GetTCSAmt("Sales Cr.Memo Header", "Sales Cr.Memo Line"))
                        {
                        }
                        /*column(ServTaxSHECessAmt_SalesCrMemoLine; "Service Tax SHE Cess Amount")
                        {
                        }
                        column(TaxAmt_SalesCrMemoLine; "Tax Amount")
                        {
                        }*/
                        ...
                        /*
                        column(ServiceTaxAmt_SalesCrMemoLine; "Service Tax SHE Cess Amount")
                        {
                            AutoFormatExpression = "Sales Cr.Memo Line".GetCurrencyCode;
                            AutoFormatType = 1;
                        }
                        column(TotalAmtInclTax_SalesCrMemoLine; "Line Amount" + "Excise Amount" + "Service Tax Amount" + "Service Tax eCess Amount" + "TDS/TCS Amount" + "Service Tax SHE Cess Amount" + "Tax Amount" + ChargesAmount)
                        {
                        }*/
                        ...
                        /*
                        column(SBCAmt; "Sales Cr.Memo Line"."Service Tax SBC Amount")
                        {
                        }
                        column(KKCAmt; "Sales Cr.Memo Line"."KK Cess Amount")
                        {
                        }*/
                        ...
                        begin
                            ...
                            */
                            ...
                            check.FormatNoText(descri1, LineTotAmt, '');//LineTotAmt1
