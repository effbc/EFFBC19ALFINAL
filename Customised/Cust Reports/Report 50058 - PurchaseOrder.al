    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("<Vendor1>"; Vendor)
            {
                ...
                column(CompanyInfo__Service_Tax_Registration_No__; CompanyInfo."Service Tax Registration No.")
                {
                }*/
                //B2BUpg<<
            ...
            begin
                ...
                */
                ...
                IF (PackingDetails = '') AND ("Purchase Header"."Order Date" > DMY2Date(12, 16, 09)) THEN
                    ERROR('PLEASE ENTER THE PACKING DETAILS');

                IF ("Purchase Header"."Payment Terms Code" = '') AND ("Purchase Header"."Order Date" > DMY2Date(12, 16, 09)) THEN
                    ERROR('PLEASE ENTER THE PAYMENT TERMS CODE FOR THIS VENDOR');
                IF ("Purchase Header"."Requested Receipt Date" = 0D) AND ("Purchase Header"."Order Date" > DMY2Date(12, 16, 09)) THEN
