codeunit 60011 "MaterialIssueOrde-Post Receipt"
{
    ...
    begin
        ...
        */
        ...
        IF NOT (USERID IN ['EFFTRONICS\RAMADEVI', 'EFFTRONICS\BHAVANIP', 'EFFTRONICS\SRIVALLI', 'EFFTRONICS\NAGALAKSHMI', 'EFFTRONICS\TPRIYANKA', 'EFFTRONICS\MPUJITHA']) THEN BEGIN
