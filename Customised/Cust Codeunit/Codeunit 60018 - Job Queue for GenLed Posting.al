        ...
        IF User.FINDSET THEN
                REPEAT
                    ...
                    IF USER_SETUP.FINDSET THEN
                        REPEAT
                                IF NOT (USER_SETUP."User ID" IN ['EFFTRONICS\RAJANI', 'EFFTRONICS\MRAJYALAKSHMI', 'EFFTRONICS\ASWINI', 'EFFTRONICS\YESU', 'EFFTRONICS\MBNAGAMANI']) THEN BEGIN
                                    USER_SETUP."Allow Posting To" := TODAY;
                                    USER_SETUP.MODIFY;
                                END
                                ELSE
                                    IF (USER_SETUP."User ID" IN ['EFFTRONICS\MRAJYALAKSHMI', 'EFFTRONICS\ASWINI']) THEN BEGIN
