codeunit 60034 "EFF Web services"
{
    ...
    */ //B2B UPG <<<<
    ...
    procedure CF_BPV_Entries(CheckNo: Code[10]; CheckDate: Code[15]; Amount: Integer; Description: Text; VendorNo: Code[20]; ExtDocNo: Code[35]; PaymentType: Code[10]; Bank_Charges: Integer; Serive_Tax_Amt: Integer; SBCess_Amt: Integer; KKCess_Amt: Integer)
    var
