page 60181 "Item Card (manu)"
{
            ...
            group(General)
            {
                ...
                field(Description; Rec.Description)
                {
                    ...
                    begin
                        IF NOT ((USERID IN ['EFFTRONICS\JHANSI', 'EFFTRONICS\RATNARAVALI', 'EFFTRONICS\RSILPARANI', 'EFFTRONICS\VANIDEVI', 'EFFTRONICS\ANANDA',
                                          ...
                                          OR ((USERID IN ['EFFTRONICS\PADMASRI', 'EFFTRONICS\MARY', 'EFFTRONICS\GRAVI']) AND (Rec."Item Category Code" IN ['OFFICE MAI', '', 'STA'])))
                                           THEN
                ...
                field("Product Group Code"; Rec."Product Group Code Cust")
                {
                    ...
                    begin
                        ...
                        IF "Product Group Code Cust" IN ['CPCB', 'FPRODUCT'] THEN
    ...
    begin
        ...
        IF (USERID IN ['EFFTRONICS\PADMASRI', 'EFFTRONICS\MARY']) AND ("Item Category Code" IN ['OFFICE MAI', '', 'STA']) THEN BEGIN
            CurrPage.EDITABLE := TRUE;
        END;
