            ...
            group(General)
            {
                ...
                field("Order Verified"; "Order Verified")
                {
                    ...
                    begin
                        ...
                        IF NOT (USERID IN ['EFFTRONICS\SUJANI', 'EFFTRONICS\VISHNUPRIYA', 'EFFTRONICS\anilkumar', 'EFFTRONICS\VSNGEETHA', 'EFFTRONICS\VANIDEVI']) THEN
                ...
                field("Verification Status"; "Verification Status")
                {
                    ...
                    begin
                        ...
                        IF (USERID IN ['EFFTRONICS\JHANSI', 'EFFTRONICS\VSNGEETHA', 'EFFTRONICS\SUJANI', 'EFFTRONICS\ANILKUMAR', 'EFFTRONICS\VANIDEVI']) THEN BEGIN
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Short Close Order")
                {
                    ...
                    begin
                        IF NOT (USERID IN ['EFFTRONICS\SUJANI', 'EFFTRONICS\ANILKUMAR', 'EFFTRONICS\VISHNUPRIYA']) THEN
