            ...
            group("Function")
            {
                ...
                action(Received)
                {
                    ...
                    begin
                        ...
                        IF (Rec."Transfer To Location" = 'SERVICE') AND NOT (USERID IN ['EFFTRONICS\SRIVALLI', 'EFFTRONICS\RAMADEVI', 'EFFTRONICS\NAGALAKSHMI', 'EFFTRONICS\ANILKUMAR', 'EFFTRONICS\SUJANI', 'EFFTRONICS\VISHNUPRIYA', 'EFFTRONICS\BHAVANIP']) THEN
                            ERROR('You do not have rights to receive');
                        IF (Rec."Transfer To Location" <> 'SERVICE') AND (USERID IN ['EFFTRONICS\SRIVALLI', 'EFFTRONICS\RAMADEVI', 'EFFTRONICS\NAGALAKSHMI', 'EFFTRONICS\BHAVANIP', 'EFFTRONICS\SUJANI']) THEN
                            ERROR('You do not have rights to receive');
