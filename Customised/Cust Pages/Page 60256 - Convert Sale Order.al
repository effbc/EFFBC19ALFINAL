        ...
        area(content)
        {
            ...
            group("To RPOs")
            {
                ...
                field("TO RPO Range"; ToRPOList)
                {
                    ...
                    begin
                        ...
                        ELSE IF Status = Status::Finished THEN
            ...
            group(New)
            {
                ...
                field("Schedule Line No1";"Schedule Line No.")
                {
                    ...
                    trigger OnValidate();
                    begin
                        IF "Schedule Line No." <> xRec."Schedule Line No." THEN
                        BEGIN
            ...
            group(Action1102152015)
            {
                action(Convert)
                {
                    ...
                    begin
                        ...
                        test:= '';
                        TotRPOQty := 0;
                        IF CONFIRM('Are Sure, You Want to Convert the Order!',FALSE) THEN
                        BEGIN
                          IF ToRPOList = '' THEN
                          BEGIN
                            ...
                            IF STRLEN(RPOList) >= STRLEN("No.") THEN
                            BEGIN
