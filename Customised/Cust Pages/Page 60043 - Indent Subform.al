page 60043 "Indent Subform"
{
    ...
    begin
        IF ((USERID <> 'EFFTRONICS\RENUKACH') AND (USERID <> 'EFFTRONICS\ANANDA') AND (USERID <> 'EFFTRONICS\BRAHMAIAH') AND (USERID <> 'EFFTRONICS\PADMASRI') AND
            (USERID <> 'EFFTRONICS\VISHNUPRIYA') AND (USERID <> 'EFFTRONICS\PARDHU') AND (USERID <> 'EFFTRONICS\ANILKUMAR') AND (USERID <> 'EFFTRONICS\PRANAVI') AND (USERID <> 'EFFTRONICS\VIJAYA') AND (USERID <> 'EFFTRONICS\JHANSI')) THEN BEGIN
