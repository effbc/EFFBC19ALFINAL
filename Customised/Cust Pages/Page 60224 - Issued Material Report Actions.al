            ...
            group("SINGLE BUTTON RETURN PROCEDURE")
            {
                ...
                action("RETURN TO STOCK")
                {
                    ...
                    begin
                        ...
                        IF (NOT (UPPERCASE(USERID) IN ['EFFTRONICS\PADMASRI', 'EFFTRONICS\ANILKUMAR', 'EFFTRONICS\JYOTHSNA', 'EFFTRONICS\GRAVI', 'EFFTRONICS\PRANAVI', 'EFFTRONICS\VIJAYA'])) THEN
                ...
                action("POST DAMAGES")
                {
                    ...
                    begin
                        ...
                        IF NOT (UPPERCASE(USERID) IN ['EFFTRONICS\GRAVI', 'EFFTRONICS\ANILKUMAR', 'EFFTRONICS\PRANAVI', 'EFFTRONICS\VIJAYA']) THEN
                ...
                action("CREATE SINGLE REQUESTS")
                {
                    ...
                    begin
                        ...
                        IF (NOT (UPPERCASE(USERID) IN ['EFFTRONICS\PADMASRI', 'EFFTRONICS\ANILKUMAR', 'EFFTRONICS\GRAVI', 'EFFTRONICS\PRANAVI', 'EFFTRONICS\VIJAYA'])) THEN
                            ERROR('YOU DONT HAVE PERMISSION TO EXECUTE THIS FUNCTIONALITY');
